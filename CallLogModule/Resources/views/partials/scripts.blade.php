...
<script src="{{ Module::getPublicPath('CallLogmodule').'/js/tui-code-snippet.min.js' }}"></script>
<script src="{{ Module::getPublicPath('CallLogmodule').'/js/tui-time-picker.min.js' }}"></script>
<script src="{{ Module::getPublicPath('CallLogmodule').'/js/tui-date-picker.min.js' }}"></script>
<script src="{{ Module::getPublicPath('CallLogmodule').'/js/tui-calendar.min.js' }}"></script>
<script src="{{ Module::getPublicPath('CallLogmodule').'/js/calendar-app.js' }}"></script>
<script>
