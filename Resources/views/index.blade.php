...
@section('stylesheets')
    @parent
    <link href="{{ asset(Module::getPublicPath('CallLogmodule').'/css/tui-time-picker.min.css') }}"
          rel="stylesheet" type="text/css">
    <link href="{{ asset(Module::getPublicPath('CallLogmodule').'/css/tui-date-picker.min.css') }}"
          rel="stylesheet" type="text/css">
    <link href="{{ asset(Module::getPublicPath('CallLogmodule').'/css/tui-calendar.min.css') }}" rel="stylesheet"
          type="text/css">
    <link href="{{ asset(Module::getPublicPath('CallLogmodule').'/css/default.css') }}" rel="stylesheet"
          type="text/css">
    <link href="{{ asset(Module::getPublicPath('CallLogmodule').'/css/icons.css') }}" rel="stylesheet"
          type="text/css">
@endsection
